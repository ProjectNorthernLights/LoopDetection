...
import pox.ext.loop_detection as loop_detection
...
class Controller (EventMixin, topology.Controller):
  ...
  _eventMixin_events = set([DiscoveredLoop, NoLoop])
  ...
  def __init__(self):
    ...
    print "about to raise event from init"
    core.raiseEvent(NoLoop)
  ...
  def _handle_PacketIn (self, event):
    ...
    print "packet is: ", event
    controller.raiseEvent(DiscoveredLoop)
